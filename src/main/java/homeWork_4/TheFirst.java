...
//      - отримати повідомлення "Операція заборонена нацбанком" і повернути назад передану суму в грн
    ...
    //========================================================
//    1.  if (x == y)  - в методі по перевірці на квадратність  , ти завжди
//    порівнюєш одне і те саме, бо х та y не змінюються.
//    2. якщо буде так перший рядок 2 , а другий три , і довжина 3 - то твій
//    метод поверне true, хоча матриця не квадратна. Потрібно додати break в
//    те місце, де ти знайшов першу неправильну сторону.
}
